          ...
          <div className="mt-8">
            <ul className="space-y-4">
              <li className="flex items-center gap-4 flex-col sm:flex-row">
                ...
                <div className="flex flex-1 items-center justify-center sm:justify-end gap-2 sm:gap-8 flex-wrap">
                  <form>
                    <div>
                  ...
                  <div className=" flex gap-4">
                    <div className="">$ 77.5</div>
                    <button className="text-primary/85 transition hover:text-red-600">
            ...
            <div className="mt-8 flex justify-end border-t border-primary/85 pt-8">
              <div className="w-screen max-w-lg space-y-4">
                ...
                <div className="flex justify-end">
                  <span className="inline-flex items-center justify-center rounded-full bg-primary/90 px-2.5 py-0.5 text-black">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
